...
impl GrayModel {
    pub fn add(&mut self, x: f32, y: f32, intensity: f32) {
        ...
        self.b[0] += x * intensity;
        self.b[1] += y * intensity;
        self.b[2] += intensity;
    }
...
fn sample_pixel(image: &Image, px: f32, py: f32) -> Option<f32> {
    ...
    let v00 = image.row(iy as usize)[ix as usize] as f32;
    let v10 = image.row(iy as usize)[ix as usize + 1] as f32;
    let v01 = image.row(iy as usize + 1)[ix as usize] as f32;
    let v11 = image.row(iy as usize + 1)[ix as usize + 1] as f32;
